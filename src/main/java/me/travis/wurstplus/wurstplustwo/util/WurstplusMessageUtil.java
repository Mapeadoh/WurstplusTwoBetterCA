...
public class WurstplusMessageUtil
{
    ...
    public static void toggle_message(final WurstplusHack module) {
        if (module.is_active()) {
            if (module.get_tag().equals("AutoCrystal")) {
                client_message_simple(WurstplusMessageUtil.opener + "we" + ChatFormatting.DARK_GREEN + " gaming ");
            }
            else {
                client_message_simple(WurstplusMessageUtil.opener + WurstplusMessageUtil.r + module.get_name() + ChatFormatting.DARK_GREEN + " Enabled");
            }
        }
        else if (module.get_tag().equals("AutoCrystal")) {
            client_message_simple(WurstplusMessageUtil.opener + "we aint" + ChatFormatting.RED + " gaming " + WurstplusMessageUtil.r + "no more");
        }
        else {
    ...
    public static void send_client_message_simple(final String message) {
        client_message(ChatFormatting.GOLD + "Wurst+ 2" + " " + WurstplusMessageUtil.r + message);
    }
    ...
    public static void send_client_error_message(final String message) {
        client_message(ChatFormatting.RED + "Wurst+ 2" + " " + WurstplusMessageUtil.r + message);
    }
    ...
    static {
        ...
        WurstplusMessageUtil.opener = WurstplusMessageUtil.g + "Wurst+ 2" + ChatFormatting.GRAY + " > " + WurstplusMessageUtil.r;
    }
