...
public class WurstplusChatSuffix extends WurstplusHack
{
    ...
    public WurstplusChatSuffix() {
        ...
        this.random_client_name = new String[] { "chad", "tabott", "travis", "unco", "kiwi", "xdolf", "eightsixfour", "biggus", "naughty", "jumpy", "chae", "wurst", "buttfuhk" };
        this.random_client_finish = new String[] { " plus", " epic", "god", " sex", " blue", " brown", " gay", "plus", "" };
            ...
            if (!(event.get_packet() instanceof CPacketChatMessage)) {
                ...
                if (this.accept_suffix) {
                    if (this.suffix_default) {
                        message = message + " " + this.convert_base("wurstplus two");
                    }
